...
def assert_operation_from_event(
    ...
    """
    Assertion for operation where expected data is obtained directly from the event
    published to Kafka.

    Compares only domain attributes which must be preserved during event-driven processing.
    """
