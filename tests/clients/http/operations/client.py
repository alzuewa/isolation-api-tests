...
class OperationsHTTPTestClient(HTTPTestClient):
    ...
    def get_operations_api(self, query: GetOperationsQueryTestSchema) -> Response:
        return self.get(f'{APITestRoutes.OPERATIONS}', params=query.model_dump(by_alias=True, exclude_none=True))
    ...
    def get_operations(self, user_id: UUID, card_id: UUID | None = None, account_id: UUID | None = None) -> GetOperationsResponseTestSchema:
